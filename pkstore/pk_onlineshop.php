                        ...
                        <?php foreach ($stmt as $row) : ?>
                            <li>
                                <div class="result-item">
                                    ...
                                    <?php if (($row['new']) == 0) { ?>
                                        <div class="relative">
                                            <img src="images_comp/<?php echo $row['item_img_path']; ?>" onclick="location.href='new-goods.php?id=<?php echo ($row['id']) ?>'" class="info-img img" width="auto" height="100px">
                                            <img src="img/newicon.png" alt="newicon" class="absolute2">
                                        </div>
                                    <?php } else { ?>
                                        <img src="images_comp/<?php echo $row['item_img_path']; ?>" onclick="location.href='new-goods.php?id=<?php echo ($row['id']) ?>'" class="info-img img" width="auto" height="100px">
                                    <?php } ?>
