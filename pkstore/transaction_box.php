...
<body>
    ...
    <div class="wrapper">
        ...
        <main>
            <h3>受注BOX</h3>
            <div class="transaction_box pk-f">
                <table>
                    <tr>
                        <th>ID</th>
                        <th>ユーザーID</th>
                    ...
                    <?php foreach ($stmt as $row) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- ★追加：削除★ -->
                                <button type="button" onclick="location.href='transaction_user_details.php?user_id=<?php echo ($row['user_id']) ?>'" class="btn btn-outline-secondary">表示</button>
