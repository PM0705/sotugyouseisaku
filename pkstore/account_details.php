            ...
            <div class="account_field">
                ...
                <div class="contact-form errorMsg">
                    ...
                    <div class="contact-submit">
                        <button type="button" class="btn btn-warning" onclick="location.href='delete_confirm_account.php?id=<?php echo ($member->id) ?>'">削除</button>
                        <button type="button" class="btn btn-primary" onclick="location.href='update_account.php?id=<?php echo ($member->id) ?>'">表示</button>
                    </div>
                </div>
