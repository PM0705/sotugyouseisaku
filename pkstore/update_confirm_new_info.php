            ...
            <div class="confirm">
                ...
                <div class="form submit1">
                    <form action="update_new_info.php" method="post">
                        <button type="button" class="btn btn-secondary" value="前に戻る" onclick="history.back()">前に戻る</button>
                    </form>
                    <form action="update_complete_new_info.php" method="post">
                        <input type="submit" class="btn btn-primary" value="更新する" href="update_complete_new_info.php<? $result['id'] ?>" name="btnSend">
