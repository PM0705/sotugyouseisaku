                ...
                <form method="post" action="update_new_info.php" name="form">
                    <div class="contact-form errorMsg">
                        ...
                        <div class="contact-submit">
                            <button type="button" class="btn btn-warning" onclick="location.href='delete_confirm_new_info.php?id=<?php echo ($member->id) ?>'">削除</button>
                            <button type="button" class="btn btn-primary" onclick="location.href='update_new_info.php?id=<?php echo ($member->id) ?>'">表示</button>
                        </div>
                    </div>
                </form>
            </div>
